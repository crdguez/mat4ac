...
\begin{tabular}{ll}
Definición de potencia: & $a^n = a \cdot a \stackrel{n}{\cdots} a$ \\
Producto de potencias de la misma base: & $a^n a^m = a^{n+m}$ \\
Cociente de potencias de la misma base: & $\dfrac{a^n}{a^m}  = a^{n-m}$ \\
Potencia de una potencia: & $\left(a^n\right)^m  = a^{n \cdot m}$ \\
Potencia de un producto: & $\left(a \cdot b \right)^n = a^n \cdot b^n$ \\
Potencia de un cociente: & $\left(\dfrac{a}{b} \right)^n = \dfrac{a^n}{a^n}$
\end{tabular}
