...
$\exists k\in\mathbb{R} | \overrightarrow{BC}=k\cdot \overrightarrow{AB}$
...
\draw [->, red, thick]  (A) -- node[below] {$\overrightarrow{AB}$} (B); 
\draw [->, red, thick]  (B) -- node[below, fill=white] {$\overrightarrow{BC}=k\cdot\overrightarrow{AB}$} (C); 
...
\draw [->, red, thick]  (A) -- node[below] {$\overrightarrow{AB}$} (B); 
\draw [->, red, thick]  (B) -- node[right, fill=white] {$\overrightarrow{BC}=\k\cdot\overrightarrow{AB}$} (C); 
