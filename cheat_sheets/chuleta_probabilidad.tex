...
\tikzset{
    ...
    \draw[A] (bottom.center) ellipse [x radius=1.5cm, y radius=.5cm];
...
\tikzset{
    ...
    % "contents" of left node
    \path (left.north west) -- node[pos=.5] {B1} (left.center);
    \path (left.north east) -- node[pos=.5] {B2} (left.center);    
    \path (left.south west) -- node[pos=.5] {B3} (left.center);
    \path (left.south east) -- node[pos=.5] {B4} (left.center);
...
\draw[B] ($(left.north west) ! .5 ! (left.south west)$) -- ($(left.north east) ! .5 ! (left.south east)$);
    ...
    % "contents" of right node
    \draw[A] (right.center) ellipse [x radius=1.5cm, y radius=.5cm] node {A};
