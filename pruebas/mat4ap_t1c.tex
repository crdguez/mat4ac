...
\newcommand{\examnum}{Enteros, fracciones y potencias}
\newcommand{\tipo}{A}
...
%\noaddpoints % to omit double points count
\begin{parts}
\part[2] $\dfrac{3}{2}-\dfrac{4}{5}:\dfrac{1}{2}+\dfrac{3}{4}\cdot\dfrac{1}{3}$ 
...
\question Simplifica utilizando las propiedades de las potencias:
%\noaddpoints % to omit double points count
\begin{parts}
\part[2] $\dfrac{3^4\cdot 3 \cdot 9^2}{3^0\cdot 3 \cdot 27}$ 
