...
\question Calcula: 
\begin{parts}
\part[1] Racionaliza y simplifica:  $\dfrac{2+\sqrt{2}}{2-\sqrt{2}}$ 
\begin{solution} $\dfrac{6\sqrt{6}}{10}$ \end{solution}
...
85º. ¿A qué altura se encuentra el globo?
...
\begin{parts}
\part[1] Cinco amigos disponen de un coche para trasladarse de un lugar
a otro. Tres de ellos saben conducir. ¿De cuántas maneras podrán colocarse para sus viajes?
\begin{solution}
$3\cdot P_4=72$
\end{solution}

\part[1] ¿Cuántas palabras se pueden formar con las letras de la palabra MIGUELON de forma que comiencen y terminen por vocal?
\begin{solution}
