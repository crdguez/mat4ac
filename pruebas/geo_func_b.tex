...
%\begin{comment}
\question Sea un paralelogramo $ABCD$ (los vértices van en sentido de las agujas del reloj). Si $A(2,3)$, $B(5,1)$ y $C(3,0)$, halla:
\begin{parts}
\part[1] El vértice $D$
...
\begin{solution}  $r_{DC}\equiv 2x+3y-6=0$\\ 
$s_{\perp r \land A}\equiv -3x+2y=0$\\
Proyección de A sobre $\overline{BC} = P(12/13, 18/13)$ \\
...
\begin{comment}
	...
	Área: $\dfrac{5\sqrt{2}\cdot\frac{16\sqrt{2}}{5}}{2}=16 \ ud^2$
	\end{solution} 
...
\right.$
\end{solution}
\part[2] Representa la función del apartado anterior gráficamente 
\begin{solution} 
