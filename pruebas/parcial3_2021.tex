...
% \part[1] $\tan{\alpha}=\sqrt{3}$\begin{solution}  \\ $\sen{\alpha}=\dfrac{\sqrt{3}}{2}, \cos{\alpha}=\dfrac{1}{2}, \tan{\alpha}=\sqrt{3}$. \\ El ángulo agudo con esas razones es: $60^{\circ}$.\end{solution} 
\end{parts} 
...
\begin{parts} 
% \part[1] Sabiendo que la hipotenusa mide 8 y un cateto 17 cm.\begin{solution} Los lados del triángulo miden: $8$, $15$, $17$ cm. Y los ángulos: $90.0 - 71.14 i$, $71.14 i$, $90$ º\end{solution} 
...
\question Resuelve\begin{parts} \part[2] Un carpintero quiere construir una escalera de tijera cuyos brazos, una vez abiertos,
formen un ángulo de 60º. Si la altura de la escalera, estando abierta es de 2m, ¿qué
longitud deberá tener cada brazo?\begin{solution} $\dfrac{4 \sqrt{3}}{3} \to 2.31\ m $\end{solution}
...
\question Resuelve: \begin{parts} \part[2] Desde el punto donde estoy, la visual al punto más alto de una torre de 100 m que tengo 
...
\question Resuelve las siguientes ecuaciones:\begin{parts} 
