...
$ 2 x^{2} - 34 x + 120 = 0 \to 2 \left(x - 12\right) \left(x - 5\right) = 0 \to \left ( 5, \quad 12\right ), \quad \left ( 12, \quad 5\right)$ \end{solution}
\end{parts}
...
\begin{solution} $ 2 \left(x - 3\right) \left(x + 1\right) \to \left(-\infty, -1\right] \cup \left[3, \infty\right)$ \end{solution}

\part[2]$x^{3} - 5 x^{2} + 6 x < 0$  
% solve_univariate_inequality (expand(x*(x-2)*(x-3))<0,x,relational =false )
\begin{solution} $ x \left(x - 3\right) \left(x - 2\right) \to \left(-\infty, 0\right) \cup \left(2, 3\right)$ \end{solution}
...
\begin{solution} $\frac{x \left(x - 1\right)}{x + 1} \to \left(-1, 0\right] \cup \left[1, \infty\right)$ \end{solution}
