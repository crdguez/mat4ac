...
\question Resuelve, justificadamente, las siguientes cuestiones relacionadas con sistemas de ecuaciones: 
\begin{parts}
...
\part[1] En las anotaciones de un camarero se podía leer: \\
...
\part[2] Calcula el área de un rectángulo sabiendo que su diagonal mide 13 m y su perímetro es 34 m.
\begin{solution}  
...
\begin{solution} $ \left(-\infty, -1\right] \cup \left[3, \infty\right)$ \end{solution}
\part[2] Resuelve la expresión del apartado anterior
\begin{solution} $ \left(-\infty, -1\right] \cup \left[3, \infty\right)$ \end{solution}
