...
\begin{parts}
% \part[1] $\left\{\begin{matrix}\frac{x}{10-x}\geq 0 \\ x^2-9 >0\end{matrix}\right.$\begin{solution} \\ $\left(3, 10\right)$\end{solution}
\part[1] $\left\{\begin{matrix}4x+2y \geq 8 \\ -x+2y < 4  \\ -x < -2\end{matrix}\right.$\begin{solution} \\ \scalebox{.99}{\includegraphics[width=1\columnwidth]{sistema_ine_ex0.png}}\end{solution}
\end{parts}
