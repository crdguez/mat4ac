...
\question Dada la función: $$y=\begin{cases} 2 x - 3 & \text{si}\: x \leq -1 \\- x^{2} + 2 x & \text{si}\: x\geq -1 \end{cases}$$
\begin{parts}
\part[2] Representa la función (puedes usar el plano cartesiano que se adjunta)
...
\question Dada la función: $$y=\begin{cases} 3 - 2 x & \text{for}\: x < 1 \\x^{2} - 6 x + 8 & \text{otherwise} \end{cases}$$
\begin{parts}
\part[2] Representa la función (puedes usar el plano cartesiano que se adjunta)
