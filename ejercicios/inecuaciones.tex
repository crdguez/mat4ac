...
\begin{solution} $\left(-\infty, -3\right] \cup \left(4, \infty\right)$\end{solution}
\part[]  $\dfrac{{2x + 6}}{{x - 5}} \geqslant 0$
\begin{solution} $\left(-\infty, -3\right] \cup \left(5, \infty\right)$ \end{solution}
\part[]  $\dfrac{{x - 8}}{{3x - 6}} < 0$

\begin{solution} $\left(2, 8\right)$\end{solution}
\part[]  $\dfrac{{x - 2}}{{x + 2}} < 0$
\begin{solution} $\left(-2, 2\right)$\end{solution}
\part[]  $\dfrac{{x + 3}}{{4x}} < 0$  
\begin{solution}$\left(-3, 0\right)$ \end{solution}
