...
\begin{solution}
$\frac{V_2^2}{V_{40}^2}=\frac{2}{40\cdot39}=\frac{1}{780}$ ó $P[(A_0\cap A_C)\cup(A_0\cap A_C)]=2\cdot	P(A_0)\cdot P(A_c|A_0)=2\cdot
\frac{1}{40\cdot 39}$
\end{solution}
...
\begin{solution}
$1-\frac{V_{30}^{2}}{V_{40}^{2}}=1-\frac{30\cdot29}{40\cdot39}=\frac{23}{52}$ ó $1-P(NO)=P(NO_1)\cdot P(NO_2 | NO_1)=1 - \frac{30}{40}\cdot \frac{29}{39}$
\end{solution}
...
\begin{solution}
$\frac{V_{8}^1 \cdot V_{4}^1}{V_{40}^{2}}=\frac{8\cdot4}{40\cdot39}=\frac{4}{195}$ ó $2\cdot P(R_1 \cap C_2)= 2 \cdot P(R_1)\cdot P(C_2 | R_1) = 2 \cdot \frac{4}{40}\cdot \frac{4}{39} $
\end{solution}
\end{parts}
...
ó $P[(A_0\cap A_C)\cup(A_0\cap A_C)]=2\cdot	P(A_0)\cdot P(A_c)=2\cdot
\frac{1}{40\cdot 40}$
\end{solution}
\part de que sean dos figuras (sota, caballo o rey)
\begin{solution}
$  \frac{VR_{12}^2}{VR_{40}^2}=\frac{12\cdot12}{40\cdot40}=\frac{9}{100}$
ó $P(2F)=P(F_1)\cdot P(F_2)=\frac{12}{40}\cdot \frac{12}{40}$
\end{solution}
\part de que al menos una sea de oros
\begin{solution}
$1-\frac{VR_{30}^{2}}{VR_{40}^{2}}=1-\frac{30\cdot30}{40\cdot40}=\frac{7}{16}$
ó $1-P(NO)=P(NO_1)\cdot P(NO_2)=1 - \frac{30}{40}\cdot \frac{30}{40}$
\end{solution}
\part de que sean dos reyes
\begin{solution}
$\frac{VR_{4}^2}{VR_{40}^{2}}=\frac{4\cdot4}{40\cdot40}=\frac{1}{100}$
ó $P(R_1 \cap R_2)=P(R_1)\cdot P(R_2) = \frac{4}{40}\cdot \frac{4}{40}$
\end{solution}
\part de que sean del mismo palo
\begin{solution}
$\frac{VR_{4}^1 \cdot VR_{10}^2}{VR_{40}^{2}}=\frac{4\cdot10\cdot10}{40\cdot40}=\frac{1}{4}$
ó $4\cdot P(P_1 \cap P_2)=4 \cdot P(P_1)\cdot P(P_2) = 4\cdot \frac{10}{40}\cdot \frac{10}{40} $
\end{solution}
\part de que sean un rey y un caballo. 
\begin{solution}
$\frac{VR_{8}^1 \cdot VR_{4}^1}{VR_{40}^{2}}=\frac{8\cdot4}{40\cdot40}=\frac{1}{50}$
ó $2\cdot P(R_1 \cap C_2)= 2 \cdot P(R_1)\cdot P(C_2) = 2 \cdot \frac{4}{40}\cdot \frac{4}{40} $
\end{solution}
\end{parts}
...
\begin{solution}
$\frac{C_8^2}{VR_8^2}=\frac{8!}{6!\cdot2!\cdot2^8}=\frac{7}{64}$ ó $C_8^2 \cdot P('66666622')=C_8^2 \cdot	 \left(\frac{1}{2}\right)^8=\frac{8!}{6!\cdot2!\cdot2^8}$
\end{solution}
