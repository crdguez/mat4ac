...
\hline
   $x_i$ &   $f_i$ &   $F_i$ &     $h_i$ &       $H_i$ &       $\%i$ &     $\%A_i$ &   $x_if_i$ &   $x^2_if_i$ \\
\hline
...
\hline
\end{tabular}$\\ \includegraphics[width=1\columnwidth]{diagrama_prueba1} \\ $\left\{ Me : 5.5, \  Mo : \left( [5], \  [4]\right), \  media : 5.47\right\}$ \\$\left\{ D4 : 4.600000000000001, \  P70 : 7.299999999999997, \  Q1 : 3.25, \  Q3 : 8.0\right\}$ \\$\left\{ C.V : 0.52, \  desv.tip : 2.84, \  rango : 10, \  var : 8.05\right\}$\\ \includegraphics[width=1\columnwidth]{caja_prueba1}\end{solution} \end{parts} 
...
\hline
   x\_i &   f\_i &   F\_i &       h\_i &       H\_i &      $\%_i$ &      $\%A_i$ \\
\hline
