...
\part[] $\log \left( {20x} \right) + \log \left( {2x} \right) = 3$ \begin{solution} $\log \left( {20x} \right) + \log \left( {2x} \right) = 3 \to 20x.2x = 1000 \to 40x = 1000 \to x^2 = 25 \to x = 5 $ \end{solution}
\part[] $\log \left( {x + 2} \right) + \log \left( {10x + 20} \right) = 3$ \begin{solution} $\log \left( {x + 2} \right) + \log \left( {10x + 20} \right) = 3 \to \left( {x + 2} \right)\left( {10x + 20} \right) = 1000 \to \left( {x + 2} \right)\left( {x + 2} \right)10 = 1000 \hfill \\
  {x^2} + 4x + 4 = 100 \to {x^2} + 4x - 96 = 0 \to x = 8$ \end{solution}
\end{parts}
\end{multicols}
