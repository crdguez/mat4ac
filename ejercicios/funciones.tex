...
\question Representa las siguientes funciones e indica sus propiedades\begin{parts} \part[1] $f(x)=x^2-4x-5$\begin{solution} \scalebox{.6}{\input{funcion_0.pgf}}\end{solution} \part[1] $f(x)=-x^2-5x+6$\begin{solution} \scalebox{.6}{\input{funcion_1.pgf}}\end{solution} \part[1] $f(x)=-x^2+4x+5$\begin{solution} \scalebox{.6}{\input{funcion_2.pgf}}\end{solution} \end{parts}


\question Representa las siguientes funciones a trozos e indica sus propiedades:

\begin{parts} \part[1] $f(x)=\begin{cases} 4 & \text{si}\: x < -2 \\- x^{2} & \text{si}\: -2 \leq x < 4 \\2 x - 3 & \text{si}\: x \geq 4 \end{cases}$\begin{solution} \scalebox{.6}{\includegraphics[width=1\columnwidth]{funcion_a_trozos_0}}\end{solution}

\part[1] $f(x)=\begin{cases} 2 x & \text{si}\: x < -3 \\x^{2} - 2 x - 8 & \text{si}\: -3 \leq x \leq 3 \\2 x - 3 & \text{si}\: x>3 \end{cases}$\begin{solution} \scalebox{.6}{\includegraphics[width=1\columnwidth]{funcion_a_trozos_1}}\end{solution}

\part[1] $f(x)=\begin{cases} x + 1 & \text{si}\: x \leq 0 \\x^{2} - 4 x + 3 & \text{si}\: x>0 \end{cases}$\begin{solution} \scalebox{.6}{\includegraphics[width=1\columnwidth]{funcion_a_trozos_2}}\end{solution} 
