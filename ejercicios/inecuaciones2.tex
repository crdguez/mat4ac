...
\begin{solution} \scalebox{.6}{\input{sistema_0.pgf}}
\end{solution}
\part[]  $\left\{ {\begin{matrix}
   {y \leqslant 2}  \\ 
   {x + y \leqslant 3}  \\ 
 ...
 \end{matrix} } \right.$
\begin{solution} \scalebox{.6}{\input{sistema_2.pgf}} \end{solution} 
...
\part[] $\left\{ {\begin{matrix}
 ...
 \end{matrix} } \right.$
\begin{solution} \scalebox{.6}{\input{sistema_1.pgf}} \end{solution}
\part[] $\left\{ {\begin{matrix}
   {x + y \leqslant 5}  \\ 
   {x + 3y \geqslant 9}  \\ 
   {y \geqslant 0}  \\ 
 ...
 \end{matrix} } \right.$
\begin{solution} \scalebox{.6}{\input{sistema_3.pgf}} \end{solution}
